...
// DONE обратите внимание на "if else" и на "else"
...
// DONE здесь обратите внимание на имена параметров
...
// DONE обратите внимание на имя функции и имена переменных
...
// DONE обратите внимание на имена переменных
func main() {
